...
## Installation
1) Drop the `VintageGallery` folder into your `VintagestoryData/Mods` directory.
2) Launch or restart the game. Load order can be anywhere; place after Better Ruins or Tradie if using those integrations.
